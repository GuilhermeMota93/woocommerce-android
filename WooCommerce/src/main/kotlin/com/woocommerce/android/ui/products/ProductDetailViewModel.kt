...
class ProductDetailViewModel @AssistedInject constructor(
    ...
    private fun updateEditProductCards(product: Product) {
        _productDetailCards.value =
            editProductCardBuilder.buildPropertyCards(product, viewState.storedProduct?.sku ?: "")
